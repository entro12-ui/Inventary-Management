...
export function ResetPasswordPage() {
  ...
  if (success) {
    return (
      <AuthShell title="Password updated" description="Your password has been reset. You can now sign in.">
  ...
  return (
    <AuthShell title="Reset password" description="Enter the code you received and your new password.">
